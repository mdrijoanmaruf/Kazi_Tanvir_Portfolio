        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="bg-linear-to-br from-purple-50 to-indigo-50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-purple-100">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-linear-to-br from-purple-600 to-indigo-600 flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-linear-to-br from-indigo-50 to-purple-50 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-indigo-100">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-linear-to-br from-indigo-600 to-purple-600 flex items-center justify-center flex-shrink-0">
