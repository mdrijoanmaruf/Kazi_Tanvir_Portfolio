        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Do you want to be even more successful? Remember one thing, it&apos;s better to take many small steps in the right direction than to make a great leap forward only to stumble backward. Learn slowly but effectively by maintaining consistency.
            </p>
            <p className="text-gray-400 text-sm">
              Copyright &copy; {currentYear} All rights reserved | This website is made with{' '}
              <span className="text-red-500">❤</span> by{' '}
              <a href="https://github.com/KaziTanvir" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300">
                Kazi Tanvir
              </a>
            </p>
          </div>
