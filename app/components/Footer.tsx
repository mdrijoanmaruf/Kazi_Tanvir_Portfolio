        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-lg bg-linear-to-br from-purple-600 to-indigo-600 flex items-center justify-center text-white font-bold text-xl shadow-md">
                KT
              </div>
              <h3 className="text-2xl font-bold text-gray-900">Kazi Tanvir</h3>
            </div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-gray-600 hover:text-purple-600 text-sm transition-colors inline-flex items-center group"
                  >
                    <span className="mr-2 text-purple-600 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                    {link.name}
                  </a>
                </li>
              ))}
            ...
            <div className="flex items-center gap-3">
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-gray-100 hover:bg-linear-to-r hover:from-purple-600 hover:to-indigo-600 text-gray-600 hover:text-white flex items-center justify-center transition-all hover:shadow-md"
