              ...
              <div className="sticky top-24">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-purple-600 transition-all hover:shadow-lg">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-linear-to-br from-purple-600 to-indigo-600 flex items-center justify-center flex-shrink-0">
                  ...
                  >
                    <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-purple-600 transition-all hover:shadow-lg">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-linear-to-br from-blue-600 to-blue-700 flex items-center justify-center flex-shrink-0">
                  ...
                  >
                    <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-purple-600 transition-all hover:shadow-lg">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-linear-to-br from-gray-800 to-gray-900 flex items-center justify-center flex-shrink-0">
                          <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-purple-600 transition-all hover:shadow-lg">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0">
                          <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
